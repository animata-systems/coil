...
Спецификация v0.3 — рабочая версия с явной статусной маркировкой. Каждая область языка имеет один из трёх нормативных статусов:
...
- Реализация COIL, заявляющая соответствие спецификации, обязана загружать диалекты из внешних диалектных таблиц; обязательная поставка конкретного диалекта не требуется. Русский и стандартный английский входят в официальную поставку.
