...
## Exemplo 2: revisão de documento

Demonstra todas as construções estáveis v0.4: expression grammar (`SE` com `E`, `OU`, `NÃO`, `VERDADEIRO`, `FALSO`), `RECEBA` com `MÁXIMO`, stream MVP (`SINAL`), `CADA` com escopo aninhado.
